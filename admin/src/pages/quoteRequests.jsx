          ...
          <div className="bg-surface-container-lowest border border-surface-variant w-full max-w-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="px-8 py-8 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8">
                ...
                <div>
                  <label className="text-[10px] font-bold text-tertiary uppercase tracking-widest block mb-1">Status Management</label>
                  <select 
              ...
              <div className="p-4 bg-surface-container-low border-l-4 border-tertiary">
                ...
                <p className="text-lg font-black text-primary uppercase tracking-tight">
                  {selectedRequest.custom_product_name || 'Standard Catalog Unit'}
                </p>
              ...
              {selectedRequest.file_url && (
                <div className="flex items-center gap-4 p-3 border border-dashed border-surface-variant rounded">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-slate-400 font-mono">technical_specs.pdf</p>
                  </div>
                  <a href={selectedRequest.file_url} target="_blank" className="text-xs font-black text-tertiary hover:underline uppercase">Download</a>
                </div>
              )}
            </div>

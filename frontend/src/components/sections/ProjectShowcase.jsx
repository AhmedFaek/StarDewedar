const projects = [
  {
    id: 1,
    title: 'Solaris Grid Expansion',
    category: 'Power Generation | 2023',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuDT6TZ7zZca3kZDUX76NaYR-t-xLD4G5rq_BtA0hvW-L41qvYNNctx4ionv0vbY6zijVwaJujFYQnB1eQUp0tMHGYPnOIFE5JkcV0DkC0XjLrOULEA-rdvtyAzfKj6spYB96vqyxvpcRA6ukT941LY3nc6pZE592_9bbXNAA7FLn26U3pnIS6rATA8hXAtBD0iM0zJdZe2AowIwcMuWUmw8B6WDIWKppRhJz_t9V2sKC7mH4Mvq9XRXbVnV9MyKXBxvfHBuo_BkcMvf',
  ...
  },
  {
    ...
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuCpkqNNzlGETxffYxX0wLmcTJw_cg31SUHKV4epvi0dqHWFOuLfdIXAo4xEiI6BEwgxP9P2QUd7EPs4aqTImCG_oqMjWjt2D6ZWGpPb9futo2gDy4uiK8LDYcWE5HldkHCXAujq5ciqIM-sOkCr43JGD5VFT0GUAQyI9zUviXXbDoEyDKCXs_T30BMc8olVfVMhHCnrke31sLVMRFVTlvW6VJZ89eA7ABHMCw_JVXGEdWosKiwnuG980HqZJXgK0knt4u0YFMYSTr9j',
  ...
  },
  {
    ...
    category: 'Manufacturing | 2023',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuA1oNoj21nPD-7EOOMhtg2mqJkCwrwSkO7beAseJQjJrV44vALHrXwmg7vbr77dvdLT3kH7I_s9p4FbzGld4wEn4AYMRgNkKkXTxoiYcnOVxQQSJIioIPB8RDSK7ni6-l8n7GdrtJhJP0ypEKUcDJPDJo7Ms2TBhhSWuwEY44HV8CBePCI30BRwUUrj_CrDI3P8p7IyOs8oTqdoqzhur9e0058knNP1S3q-fGZmKX9oNpnxP-10W2vEXnhO0QY4PPw1KuRn2CvhVlQu',
    colSpan: 'md:col-span-4',
    rowSpan: 'h-80',
    featured: false,
  },
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 h-[800px]">
          {projects.map((project) => (
            ...
            >
              ...
              {/* Overlay - Colored background for non-featured on hover */}
              {!project.featured && (

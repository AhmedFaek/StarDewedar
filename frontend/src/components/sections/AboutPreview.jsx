      ...
      <div className="container mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-center">
          ...
          <div className="md:col-span-7">
            <h2 className="font-headline text-4xl md:text-6xl font-bold tracking-tighter text-primary mb-8">
            ...
            <div className="flex items-center gap-12 border-t border-outline-variant/15 pt-8">
              <div>
                <div className="font-headline text-4xl font-bold text-primary">25+</div>
                <div className="font-label uppercase text-xs tracking-widest text-outline">
                  Years Expertise
                </div>
              </div>
              <div>
                <div className="font-headline text-4xl font-bold text-primary">500+</div>
                <div className="font-label uppercase text-xs tracking-widest text-outline">
                  Global Projects
                </div>
              </div>
          ...
          <div className="md:col-span-5 bg-surface-container-low p-12">
            <h3 className="font-headline text-xl font-bold uppercase tracking-tight mb-4 border-b border-tertiary-fixed pb-2 w-fit">
